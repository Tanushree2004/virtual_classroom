...
def helpbot_home(request):
    if request.user.is_authenticated:
        ...
        bot_name = preference.helpbot_name  # Adjust according to your field (if not defined, you might set a default name field)
    else:
        bot_name = "HelpBot"
...
def update_helpbot_name(request):
    ...
    if new_name:
        # Assuming each user has an associated UserPreference instance

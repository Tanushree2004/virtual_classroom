...
from .views import instructor_dashboard_asg, student_dashboard_asg, dashboard_redirect_asg, create_assignment, add_questions,edit_question,delete_question, finalize_assignment, delete_assignment, extend_deadline, submit_assignment, view_student_submission, view_submissions, add_remark, mark_notification_read, details_asg, submission_details
...
urlpatterns = [
    ...
    path('details_asg/<int:assignment_id>/', details_asg, name="details_asg"),
    ...
    path('submission_details/<int:assignment_id>/',submission_details, name="submission_details"),
]
if settings.DEBUG:
